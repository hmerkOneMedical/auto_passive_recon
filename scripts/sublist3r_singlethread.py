...
def banner():
    print("""%s
      •          ____        _     _ _     _   _____
      |         / ___| _   _| |__ | (_)___| |_|___ / _ __ ---- SINGLE THREAD EDITION - •
     -          \___ \| | | | '_ \| | / __| __| |_ \| '__|
    |            ___) | |_| | |_) | | \__ \ |_ ___) | |
     - - - - - -|____/ \__,_|_.__/|_|_|___/\__|____/|_|%s%s

                # modified by Helena Merk - @helenamerk (original by Ahmed Aboul-Ela - @aboul3la)
    """ % (R, W, Y))
...
# ## add later -- gotta find one that is found.
# class Virustotal():
#     def __init__(self, domain, subdomains=None, q=None, silent=False, verbose=True):
#         subdomains = subdomains or []
